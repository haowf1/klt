package com.hw.klt.ktlActivity.home.New;
...
import com.hw.klt.dagger.Component.DaggerNewsArticleComponent;
...
import com.hw.klt.util.AnimateHelper;
import com.hw.klt.util.DialogHelper;
import com.hw.klt.util.ListUtils;
import com.hw.klt.util.NewsUtils;
import com.hw.klt.util.PreferencesUtils;
import com.hw.klt.widget.EmptyLayout;
import com.hw.klt.widget.PullScrollView;
    ...
    private void _showPopup() {
        if (PreferencesUtils.getBoolean(this, SHOW_POPUP_DETAIL, true)) {
            ...
            DialogHelper.createPopup(this, R.layout.layout_popup_bottom)
                    ...
                    .autoDismissDelay(3500)
                    .show();
            PreferencesUtils.saveBoolean(this, SHOW_POPUP_DETAIL, false);
        }
    }
