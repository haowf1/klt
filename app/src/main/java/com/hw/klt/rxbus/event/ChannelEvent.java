package com.hw.klt.rxbus.event;
...
public class ChannelEvent {
    ...
    public MovieTypeInfo movieInfo;
    ...
    public void setMovieTypeInfo(MovieTypeInfo movieInfo){
        this.movieInfo = movieInfo;
    }

    public void setNewsTypeInfo(NewsTypeInfo newsInfo){
        this.newsInfo = newsInfo;
    }
