...
import com.hw.ktlplayer.uilt.TableLayoutBinder;
...
public class ViewHolderInfoManager {
    private  final String TAG = "ViewHolderInfoManager";
    TableLayoutBinder mTableLayoutBinder;
    private SparseArray<View> mRowMap = new SparseArray<View>();
    private IMediaPlayer mMediaPlayer;
    private long mLoadCost = 0;
    private long mSeekCost = 0;

    public ViewHolderInfoManager(Context context, TableLayout tableLayout) {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_UPDATE_HUD: {
                    ViewHolderInfoManager holder = ViewHolderInfoManager.this;
